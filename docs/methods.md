...
All methods are global and can be called at any moment of the gameplay after the plugin is initialized by RED4ext. They require DLSS Enabler to be installed and Frame Generation enabled in the game.
